...
import io.nebula.util.CollectionUtil;
    ...
    private static <S> S loadFile(Class<S> service, String activateName, ClassLoader loader) {
        try {
            ...
            if (StringUtil.isNotEmpty(activateName)) {
                loadFile(service, SERVICES_DIRECTORY + activateName.toLowerCase() + "/", loader, extensions);
            ...
            if (e instanceof EnhancedServiceNotFoundException) {
                ...
                throw new EnhancedServiceNotFoundException(
                        "not found service provider for : " + service.getName() + " caused by " + e.getStackTrace());
            }
        }
    }

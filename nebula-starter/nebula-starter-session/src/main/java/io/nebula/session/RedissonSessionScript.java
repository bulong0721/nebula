...
public abstract class RedissonSessionScript {
    ...
    public static final String INIT_SCRIPT =
            "redis.call('HMSET', KEYS[1], '\"" + RedissonSession.INFO_ID_KEY + "\"', ARGV[1], '\"" + RedissonSession.INFO_TIMEOUT_KEY + "\"', ARGV[2],\n" +
                    "  '\"" + RedissonSession.INFO_START_KEY + "\"', ARGV[3], '\"" + RedissonSession.INFO_LAST_KEY + "\"', ARGV[3],\n" +

...
public class ClassPathJobScanner extends ClassPathBeanDefinitionScanner {
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            if (metadata.hasAnnotation(Schedule.class.getName())) {
                ...
                ElasticConfig elasticConfig = toScheduleConfig(metadata.getAnnotationAttributes(Schedule.class.getName()));
                scheduler.getPropertyValues().addPropertyValue("elasticConfig", elasticConfig);
    ...
    private ElasticConfig toScheduleConfig(Map<String, Object> metadataSet) {
